...
<title>Studio Legale Bocchietti - links</title>
    ...
    <tr>
      ...
      <td width="140" class="td31" valign="top">
        <div align="right">
          ...
          <tr>
            <td>
              <p align="right" class="blue"><b>Links</b></td>
  <center>
  <td width="10" height="10"></td>
            </tr>
          </table>
        ...
        <table border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="540" valign="top">
                <p class="titolo"><img border="0" src="immagini/links.jpg">
                <p class="blue">In questa sezione troverete collegamenti a
                siti di comune interesse ed utilità:
                <p class="blue">&nbsp;<p class="blue">Camera Civile di Como<p class="titolo"><a href="http://www.cameracivilecomo.it" target="_new1" title="vai al sito"><img border="0" src="immagini/camera_civile.jpg"></a>
                <p class="titolo">&nbsp;
                <p class="titolo">&nbsp;
                <p class="titolo">&nbsp;</td>
            <td width="10"></td>
