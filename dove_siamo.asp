...
<title>Studio Legale Bocchietti - dove siamo</title>
    ...
    <tr>
      ...
      <td width="140" class="td31" valign="top">
        <div align="right">
          ...
          <tr>
            <td>
              <p align="right" class="blue"><b>Dove Siamo</b></td>
  <center>
  <td width="10" height="10"></td>
            </tr>
          </table>
        ...
        <table border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="540" valign="top">
                <p class="titolo"><img border="0" src="immagini/dovesiamo.jpg">
                <p class="blue">Lo Studio Legale Bocchietti si trova a Como, in
                Via Volta 40
                <p class="blue">tel. 031/26.41.10 - fax 031/26.02.07<p class="testo"><img border="0" src="immagini/mappa.jpg"></td>
            <td width="10"></td>
          </tr>
          <tr>
            <td width="10" height="10"></td>
